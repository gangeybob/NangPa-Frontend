        ...
        <Col xs={12}>
          ...
          <Wrapping className="d-flex flex-wrap">
            ...
            <Button
              variant="white"
              onClick={handleShow}
              className="btn-error-modal w-50 h-100 link-mypage1"
            >
              내가 받은
              <br />
              뱃지
            ...
            <Button
              variant="white"
              className="btn-error-modal w-50 h-100  link-mypage2"
            >
              냉파
              <br />
              달력
            ...
            <Button
              variant="white"
              onClick={handleShow}
              className="btn-error-modal w-50 h-100  link-mypage3"
            >
              저장한
              <br />
              레시피
            ...
            <Button
              variant="white"
              className="btn-error-modal w-50 h-100 link-mypage4"
            >
              내가 만든
              <br />
              레시피
