...
import { Container, Card, ListGroupItem, ListGroup, Row, Col, InputGroup, Form, Button, ButtonGroup, ToggleButton } from 'react-bootstrap';
...
function Community() {
    ...
    const cardInfo = [
        { image: 'https://i.pinimg.com/564x/fd/ef/df/fdefdf72005e565dc9a8abcabe4761a3.jpg', title: '카망베르 치즈 돈까스' },
        { image: 'https://i.pinimg.com/564x/f8/49/6d/f8496d5213fed11a3b89ba50bade351e.jpg', title: '꿀떡꿀떡 맛나는 - 간장꿀컵떡볶이' },
        {
        ...
        { image: 'https://i.pinimg.com/564x/6d/32/d6/6d32d6728bd61f41699998f17d6deb44.jpg', title: '머랭 팬케이크 만들기' },
        {
            ...
            <Row>
                <Col xs='12'>
                    <InputGroup className='mb-3'>
                        ...
                        <Form.Control placeholder='레시피를 검색하세요' aria-label='레시피를 검색하세요' aria-describedby='basic-addon1' />
